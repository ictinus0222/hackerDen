        ...
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
          ...
          {getPublicUrl() ? (
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:space-x-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 sm:flex-none px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-sm font-medium touch-manipulation"
                  >
                    Copy
                  </button>
                  <a
                    ...
                    className="flex-1 sm:flex-none px-3 sm:px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 text-sm font-medium text-center touch-manipulation"
                  >
                    Preview
                  </a>
                </div>
              ...
              {/* Submission Status */}
              <div className="flex items-start sm:items-center space-x-2 text-sm">
                {submission.isComplete ? (
                  ...
                  <>
                    <svg className="w-4 h-4 text-yellow-500 flex-shrink-0 mt-0.5 sm:mt-0" fill="currentColor" viewBox="0 0 20 20">
