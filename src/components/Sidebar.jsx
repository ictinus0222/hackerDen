        ...
        <div className="flex flex-col h-screen w-sidebar border-r border-gray-700 overflow-hidden" style={{ background: '#1A2423' }}>
          ...
          <div className="p-6 border-t border-gray-700 flex-shrink-0">
            ...
            <Button
              ...
              className="w-full flex items-center space-x-4 px-5 py-4 text-body font-medium text-destructive hover:text-destructive/80 hover:bg-destructive/10 border-destructive/30 hover:border-destructive/50"
            >
