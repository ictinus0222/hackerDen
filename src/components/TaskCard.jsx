        ...
        <div className="flex items-start justify-between mb-2">
          ...
          <div className="flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-all duration-200">
            <button
              ...
              className="p-1 rounded-md hover:bg-blue-500/20 text-slate-400 hover:text-blue-400 hover:scale-110 flex-shrink-0"
            ...
            <button
              ...
              className="p-1 rounded-md hover:bg-red-500/20 text-slate-400 hover:text-red-400 hover:scale-110 flex-shrink-0"
